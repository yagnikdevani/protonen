...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Products", 'products', 'category', 'fa-cube', [
            ["category", "Category", "Dropdown", false, "", 0, 0, true, "@categories"],
            ["name", "Name", "Name", false, "", 0, 250, true],
            ["image", "Image", "File", false, "", 0, 0, false],
